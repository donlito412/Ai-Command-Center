...
- **Expected Outputs**:
  ...
  - Specialized Contract Agent, Research Agent, and Media/Wealth Agent schemas and endpoints
  - Operational chat interface allowing real-time prompts and agent outputs
